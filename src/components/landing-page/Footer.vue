<template>
  <footer>
    <v-container>
      <div class="footer_container flex items-center justify-evenly">
        <div
          class="flex flex-col md:flex-row items-start justify-around lg:justify-center"
        >
          <div class="lg:flex">
            <div>
              <img
          ...
          <div class="lg:flex">
            <div class="links_section">
              <ul>
                <p class="links_heading">Support</p>
            ...
            <div class="links_section">
              <ul>
                <p class="links_heading">Get the app</p>
    ...
    <div class="footer_bottom">
      ...
      <p class="copy_right">&copy; 2021 Tripma Inc.</p>
    </div>
  </footer>
</template>
